...
local function buf_set_keymaps(bufnr)
  ...
  buf_set_keymap("v", "<space>ar", vim.lsp.buf.range_code_action)

  buf_set_keymap("n", "<leader>ll", find_and_run_codelens)
  ...
  buf_set_keymap("n", "<space>lk", vim.lsp.buf.signature_help)
  -- Docs
  buf_set_keymap("n", "gT", "<cmd>Lspsaga signature_help")
  buf_set_keymap("i", "<M-p>", vim.lsp.buf.signature_help)

  buf_set_keymap("n", "<leader>ws", telescope_lsp.workspace_symbols)
end
